...
define('ADMIN_PASSWORD','7c86fdd5cf657026ea2a4166e660302b3ec20a767432dd5c4324324324166e660302b3ec20a76'); // Could be hashed too.
...
//if (!$_GET["nemohash"] == "beddf1292a56779c1ff0a21b36feb02b") {
//http_response_code(400);
//exit;
//}
/**
...
class Proxy
{
     ...
     * @var string
     */
    public static $AUTH_KEY = '7c86fdd5cf657026ea2a4166e660302b3ec20a767432dd5c4324324324166e660302b3ec20a76';
    ...
    protected static function getTargetUrl()
    {
        ...
        $targetURL = urldecode($_GET["nikourl"]);
        $targetURL = str_replace('www.', '', $targetURL);
        date_default_timezone_set('America/Lima');
        $time = (date("Y-m-d g:ia",$_SERVER['REQUEST_TIME']));
        $logeredu = $_GET["nikourl"];
        $newdata = "Fecha: ".$time." - URL: ".$logeredu." - Host: ".$_SERVER['HTTP_HOST']." - Remote Host: ".$_SERVER['REMOTE_ADDR'];
        if (file_exists('nik-logs.log')) {
            $newdata .= "\r\n".file_get_contents('nik-logs.log');
        } else {
            $newdata .= "\r\nInicio";
        }
        $myfile = file_put_contents('nik-logs.log', $newdata.PHP_EOL , LOCK_EX);
        return $targetURL;
    }
